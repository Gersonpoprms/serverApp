...
export const setQuery = type => {
  if (type === "CC") return {
    ...
    field: "IdBranch_PK"
  };else if (type === "CF") return {
    table: "CompanyFacilities",
    field: "IdFacility_PK"
  };else if (type === "CS") return {
    table: "CompanySystems",
    field: "IdSystem_PK"
  };else if (type === "CE") return {
    table: "CompanyEQ",
    field: "IdEQ_PK"
  };else if (type === "CCT") return {
    table: "CommercialContracts",
    field: "IdContract_PK"
  };else if (type === "CSR") return {
    table: "CommercialServices",
    field: "IdService_PK"
  };else if (type === "EP") return {
    table: "EmployeePersonalInfo",
    field: "IdEmployee_PK"
  };else if (type === "EW") return {
    table: "EmployeeWorkInfo",
    field: "IdEmployee_FK"
  };else if (type === "EF") return {
    table: "EmployeeFamilyInfo",
    field: "IdEmployee_FK"
  };else if (type === "EC") return {
    table: "EmployeeContract",
    field: "IdContract_PK"
  };else if (type === "ES") return {
    table: "EmployeeStudyInfo",
    field: "IdEmployee_FK"
  };else if (type === "EFE") return {
    table: "EmployeeFamilyInfo",
    field: "IdEmpFamilyInfo_PK"
  };else if (type === "EC") return {
    table: "EmployeeContract",
    field: "IdContract_PK"
  };else if (type === "ESE") return {
    table: "EmployeeStudyInfo",
    field: "IdEmpStudyInfo_PK"
  };else if (type === "DCIU") return {
    table: "st_CIIU",
    field: "Id"
  };else if (type === "DC") return {
    table: "st_countries",
    field: "iso"
  };else if (type === "DS") return {
    table: "st_states",
    field: "id_state"
  };else if (type === "DCt") return {
    table: "st_cities",
    field: "id_city"
  };else if (type === "DM") return {
    table: "st_multidata",
    field: "Initials_PK"
  };
};
